package com.videojs{
    ...
    public class VideoJSModel extends EventDispatcher{
        ...
        public function VideoJSModel(pLock:SingletonLock, rectangle:Rectangle){
        ...
        public static function getInstance(rectangle:Rectangle=null):VideoJSModel {
            if (_instance === null){
                _instance = new VideoJSModel(new SingletonLock(), rectangle);
            }
            return _instance;
        }
        ...
        public function set src(pValue:String):void { //http-flv
            ExternalInterface.call('videojs.Flash.test2', _currentPlaybackType, '001');
            _src = pValue;
            _rtmpConnectionURL = "";
            _rtmpStream = "";
            _currentPlaybackType = PlaybackType.HTTP;
            ExternalInterface.call('videojs.Flash.test2', _currentPlaybackType, '002');
        ...
        public function set rtmpStream(pValue:String):void {
            ExternalInterface.call('videojs.Flash.test2', _currentPlaybackType, 'trmp1111002');
            _src = "";
            _rtmpStream = pValue;
            broadcastEventExternally(ExternalEventName.ON_SRC_CHANGE, _src);
        ...
        public function play():void {
            ...
            //broadcastEvent(new VideoJSEvent(VideoJSEvent.STAGE_RESIZE, {}));
            ExternalInterface.call('videojs.Flash.test',  'play2');
        }
