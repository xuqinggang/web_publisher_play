package{
    ...
    public class VideoJS extends Sprite{
        ...
        private function init():void{
            ...
            _app = new VideoJSApp(new Rectangle(0, 0, stage.stageWidth, stage.stageHeight));
            addChild(_app);

            //_app.model.stageRect = new Rectangle(0, 0, stage.stageWidth, stage.stageHeight);
            //ExternalInterface.call('videojs.Flash.test2', _model.metadata.width = 1000, _model.metadata.height = 1000, _uiVideo.width, _uiVideo.height);
        ...
        private function registerExternalMethods():void{
            ...
            try{
                ...
                ExternalInterface.addCallback("vjs_test", onTest);
            }
        ...
        private function onAddedToStage(e:Event):void{ //先触发添加stage
            ExternalInterface.call('videojs.Flash.test',  'stagesize1');
        ...
        private function onStageSizeTimerTick(e:TimerEvent):void{//start触发stageSize
            //ExternalInterface.call('videojs.Flash.test',  stage.stageWidth, stage.stageHeight, '1112!');
        ...
        private function onStageResize(e:Event):void{
            if(_app != null){
                _app.model.stageRect = new Rectangle(0, 0, stage.stageWidth, stage.stageHeight);
               ExternalInterface.call('videojs.Flash.test',  'stagesize2');
               ExternalInterface.call('videojs.Flash.test',  _app.uiView.uiVideo.width);
        ...
        private function onSrcCalled(pSrc:* = ""):void{
            ExternalInterface.call('videojs.Flash.test2', pSrc, '000');
        ...
        private function onPlayCalled():void{
            _app.model.play();
            //ExternalInterface.call('videojs.Flash.test', ExternalInterface.objectID, 3);
        }
        ...
        private function onStageClick(e:MouseEvent):void{
            ExternalInterface.call('videojs.Flash.test',  'stagesize23');
