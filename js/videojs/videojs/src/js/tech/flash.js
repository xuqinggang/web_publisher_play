...
class Flash extends Tech {
  ...
  constructor(options, ready){
    ...
    window.videojs.Flash.onError = Flash.onError;
    window.videojs.Flash.test = Flash.test;
    window.videojs.Flash.test2 = Flash.test2;
...
Flash.test = function(swfID, err){
  // console.log(Dom.getEl(swfID).tech.el_.vjs_getProperty('metadata'));
  console.log('!');
  console.log(arguments, 3);
};
Flash.test2 = function(swfID, err){
  // console.log(Dom.getEl(swfID).tech.el_.vjs_getProperty('metadata'));
  // console.log('!');
